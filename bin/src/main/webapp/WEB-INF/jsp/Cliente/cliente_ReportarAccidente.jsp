		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link" href="#"
					...
					aria-haspopup="true" aria-expanded="false">Solicitar asesoria</a></li>
				<li class="nav-item"><a class="nav-link" href="#" role="button"
					data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Reportar
						accidente</a></li>
			</ul>
	...
	<div class="container">
		...
		<nav class="breadcrumb" aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Reportar
					accidente</li>
			</ol>
		</nav>
		...
		<form action="/guardaAccidente" method="get">
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="nomSolicita">Nombre Solicitante</label> <input
						type="text" name="nomSolicita" class="form-control"
						placeholder="Tu nombre aquí">
				</div>
				<div class="form-group col-md-6">
					<label for="rutSolicita">Rut Solicitante</label> <input type="text"
						name="rutSolicita" class="form-control" placeholder="23.123.543-k">
				</div>
				<div class="form-group col-md-6">
					<label for="nomEmpresa">Nombre Empresa</label> <input type="text"
						name="nomEmpresa" class="form-control"
						placeholder="Tu nombre aquí">
				</div>
				<div class="form-group col-md-6">
					<label for="rutEmpresa">Rut Empresa</label> <input type="text"
						name="rutEmpresa" class="form-control" placeholder="76.454.234-6">
				</div>
			</div>
			<div class="form-group">
				<label for="direccion">Dirección Empresa</label> <input type="text"
					name="direccion" class="form-control"
					placeholder="Avenida siempre viva, 742">
			</div>
			<div class="form-group">
				<label for="referencia">Añade una referencia</label> <input
					type="text" name="referencia" class="form-control"
					placeholder="Casa morada con ventanal a la calle">
			</div>
			<div class="form-row">
				<div class="form-group col-md-4">
					<label for="region">Región de empresa</label> <select
						id="inputRegion" name="region" class="form-control">
				...
				<div class="form-group col-md-4">
					<label for="comuna">Comuna de empresa</label> <select
						id="inputComuna" name="comuna" class="form-control">
				...
				<div class="form-group col-md-4">
					<label for="nivAccidente">Nivel de accidente</label> <select
						id="inputAsesoria" name="nivAccidente" class="form-control">
			...
			<div class="form-group">
				...
				<textarea name="accidente" class="form-control" rows="4"
