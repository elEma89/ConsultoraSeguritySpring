    ...
    <div class="container">
      ...
      <nav class="breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Crear capacitación</li>
        </ol>
      </nav>
      
      <h1 class="py-5 text-center">Crear Capacitación</h1>
      ...
      <form>
        ...
        <div class="form-group">
          <label for="inputAddress">Dirección de empresa a capacitar</label>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            <label for="inputCap">Seleccione capacitación</label>
            <select id="inputCap" class="form-control">
                <option selected>--Capacitación--</option>
          ...
          <div class="form-group col-md-4">
            <label for="inputCap">A quien esta dirigida la capacitación</label>
            <select id="inputCap" class="form-control">
                <option selected>--Capacitación--</option>
