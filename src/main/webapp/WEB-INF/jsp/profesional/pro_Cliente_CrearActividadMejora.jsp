...
<body>
    ...
    <div class="container">
      ...
      <h1 class="py-5 text-center">Crear actividad de mejora</h1>
      ...
      <form>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            <label for="inputAsesoria">Tipo de mejora</label>
            <select id="inputAsesoria" class="form-control">
                <option selected>--Mejora--</option>
                    <option>Mejora 1</option>
                    <option>Mejora 2</option>
                    <option>Mejora 3</option>
                    <option>Mejora 4</option>
            </select>
          </div>
        </div>
        <div class="form-group">
            <label for="Textarea1">Detalle de la actividad</label>
