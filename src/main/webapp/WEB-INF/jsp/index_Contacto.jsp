...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="/contacto"
					id="navbarDropdown" role="button" data-toggle="dropdown"
	...
	<div class="container">
		...
		<h1 class="display-2 py-5 text-center">Te ayudamos con la
			prevención</h1>
		...
		<form>
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputMail">Nombre</label> <input type="text"
						class="form-control" placeholder="Nombre">
				</div>
				<div class="form-group col-md-6">
					<label for="inputMail">Apellido</label> <input type="text"
						class="form-control" placeholder="Apellido">
				</div>
				<div class="form-group col-md-6">
					<label for="inputMail">Correo</label> <input type="user"
						class="form-control" id="inputUser1" aria-describedby="user"
						placeholder="Tu mail">
				</div>
				<div class="form-group col-md-6">
					<label for="inputMail">Móvil</label> <input type="user"
						class="form-control" id="inputUser1" aria-describedby="user"
